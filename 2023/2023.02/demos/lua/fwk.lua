--autogenerated luajit bindings. do not edit. 2023/02/25
...
union data_t* arr;
 ...
 bool            data_push(const char *json_content);
...
float specular_shininess;
 ...
 void sprite_sheet( texture_t texture, float sheet[3], float position[3], float rotation, float offset[2], float scale[2], int is_additive, uint32_t rgba);
 void sprite_flush();
...
int u_coefficients_sh;
 ...
 int    ui_stringf(const char *label, char **string);
