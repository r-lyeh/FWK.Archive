...
typedef enum {
  KSINTERFACE_MEDIA_MUSIC,KSINTERFACE_MEDIA_WAVE_BUFFERED,KSINTERFACE_MEDIA_WAVE_QUEUED
} KSINTERFACE_MEDIA;

#ifndef INIT_USBAUDIO_MID
#define INIT_USBAUDIO_MID(guid,id){ (guid)->Data1 = 0x4e1cecd2 + (USHORT)(id); (guid)->Data2 = 0x1679; (guid)->Data3 = 0x463b; (guid)->Data4[0] = 0xa7; (guid)->Data4[1] = 0x2f; (guid)->Data4[2] = 0xa5; (guid)->Data4[3] = 0xbf; (guid)->Data4[4] = 0x64; (guid)->Data4[5] = 0xc8; (guid)->Data4[6] = 0x6e; (guid)->Data4[7] = 0xba;}
...
#define INIT_USB_TERMINAL(guid,id){ (guid)->Data1 = 0xDFF219E0 + (USHORT)(id); (guid)->Data2 = 0xF70F; (guid)->Data3 = 0x11D0; (guid)->Data4[0] = 0xb9; (guid)->Data4[1] = 0x17; (guid)->Data4[2] = 0x00; (guid)->Data4[3] = 0xa0; (guid)->Data4[4] = 0xc9; (guid)->Data4[5] = 0x22; (guid)->Data4[6] = 0x31; (guid)->Data4[7] = 0x96;}
...
typedef enum {
  KSPROPERTY_DIRECTSOUND3DBUFFER_ALL,KSPROPERTY_DIRECTSOUND3DBUFFER_POSITION,KSPROPERTY_DIRECTSOUND3DBUFFER_VELOCITY,
  ...
  KSPROPERTY_DIRECTSOUND3DBUFFER_MINDISTANCE,KSPROPERTY_DIRECTSOUND3DBUFFER_MAXDISTANCE,KSPROPERTY_DIRECTSOUND3DBUFFER_MODE
...
typedef enum {
  FULL_FILTER,LIGHT_FILTER,KSDS3D_FILTER_QUALITY_COUNT
...
typedef enum {
  DIRECT_FORM,CASCADE_FORM,KSDS3D_FILTER_METHOD_COUNT
...
typedef enum {
  KSPROPERTY_HRTF3D_PARAMS = 0,KSPROPERTY_HRTF3D_INITIALIZE,KSPROPERTY_HRTF3D_FILTER_FORMAT
} KSPROPERTY_HRTF3D;
...
typedef enum {
  KSPROPERTY_BIBLIOGRAPHIC_LEADER = 'RDL ',KSPROPERTY_BIBLIOGRAPHIC_LCCN = '010 ',KSPROPERTY_BIBLIOGRAPHIC_ISBN = '020 ',
  KSPROPERTY_BIBLIOGRAPHIC_ISSN = '220 ',KSPROPERTY_BIBLIOGRAPHIC_CATALOGINGSOURCE = '040 ',
  KSPROPERTY_BIBLIOGRAPHIC_MAINPERSONALNAME = '001 ',KSPROPERTY_BIBLIOGRAPHIC_MAINCORPORATEBODY = '011 ',
  KSPROPERTY_BIBLIOGRAPHIC_MAINMEETINGNAME = '111 ',KSPROPERTY_BIBLIOGRAPHIC_MAINUNIFORMTITLE = '031 ',
  KSPROPERTY_BIBLIOGRAPHIC_UNIFORMTITLE = '042 ',KSPROPERTY_BIBLIOGRAPHIC_TITLESTATEMENT = '542 ',KSPROPERTY_BIBLIOGRAPHIC_VARYINGFORMTITLE = '642 ',
  KSPROPERTY_BIBLIOGRAPHIC_PUBLICATION = '062 ',KSPROPERTY_BIBLIOGRAPHIC_PHYSICALDESCRIPTION = '003 ',KSPROPERTY_BIBLIOGRAPHIC_ADDEDENTRYTITLE = '044 ',
  KSPROPERTY_BIBLIOGRAPHIC_SERIESSTATEMENT = '094 ',KSPROPERTY_BIBLIOGRAPHIC_GENERALNOTE = '005 ',KSPROPERTY_BIBLIOGRAPHIC_BIBLIOGRAPHYNOTE = '405 ',
  KSPROPERTY_BIBLIOGRAPHIC_CONTENTSNOTE = '505 ',KSPROPERTY_BIBLIOGRAPHIC_CREATIONCREDIT = '805 ',KSPROPERTY_BIBLIOGRAPHIC_CITATION = '015 ',
  KSPROPERTY_BIBLIOGRAPHIC_PARTICIPANT = '115 ',KSPROPERTY_BIBLIOGRAPHIC_SUMMARY = '025 ',KSPROPERTY_BIBLIOGRAPHIC_TARGETAUDIENCE = '125 ',
  KSPROPERTY_BIBLIOGRAPHIC_ADDEDFORMAVAILABLE = '035 ',KSPROPERTY_BIBLIOGRAPHIC_SYSTEMDETAILS = '835 ',KSPROPERTY_BIBLIOGRAPHIC_AWARDS = '685 ',
  KSPROPERTY_BIBLIOGRAPHIC_ADDEDENTRYPERSONALNAME = '006 ',KSPROPERTY_BIBLIOGRAPHIC_ADDEDENTRYTOPICALTERM = '056 ',
  KSPROPERTY_BIBLIOGRAPHIC_ADDEDENTRYGEOGRAPHIC = '156 ',KSPROPERTY_BIBLIOGRAPHIC_INDEXTERMGENRE = '556 ',
  KSPROPERTY_BIBLIOGRAPHIC_INDEXTERMCURRICULUM = '856 ',KSPROPERTY_BIBLIOGRAPHIC_ADDEDENTRYUNIFORMTITLE = '037 ',
  KSPROPERTY_BIBLIOGRAPHIC_ADDEDENTRYRELATED = '047 ',KSPROPERTY_BIBLIOGRAPHIC_SERIESSTATEMENTPERSONALNAME = '008 ',
...
typedef enum {
  KSPROPERTY_TOPOLOGYNODE_ENABLE = 1,KSPROPERTY_TOPOLOGYNODE_RESET
...
typedef enum {
  ...
  KSPROPERTY_AUDIO_MUTE,KSPROPERTY_AUDIO_BASS,KSPROPERTY_AUDIO_MID,KSPROPERTY_AUDIO_TREBLE,KSPROPERTY_AUDIO_BASS_BOOST,KSPROPERTY_AUDIO_EQ_LEVEL,
  KSPROPERTY_AUDIO_NUM_EQ_BANDS,KSPROPERTY_AUDIO_EQ_BANDS,KSPROPERTY_AUDIO_AGC,KSPROPERTY_AUDIO_DELAY,KSPROPERTY_AUDIO_LOUDNESS,
  KSPROPERTY_AUDIO_WIDE_MODE,KSPROPERTY_AUDIO_WIDENESS,KSPROPERTY_AUDIO_REVERB_LEVEL,KSPROPERTY_AUDIO_CHORUS_LEVEL,KSPROPERTY_AUDIO_DEV_SPECIFIC,
...
typedef enum {
  SE_TECH_NONE,SE_TECH_ANALOG_DEVICES_PHAT,SE_TECH_CREATIVE,SE_TECH_NATIONAL_SEMI,SE_TECH_YAMAHA_YMERSION,SE_TECH_BBE,SE_TECH_CRYSTAL_SEMI,
  SE_TECH_QSOUND_QXPANDER,SE_TECH_SPATIALIZER,SE_TECH_SRS,SE_TECH_PLATFORM_TECH,SE_TECH_AKM,SE_TECH_AUREAL,SE_TECH_AZTECH,SE_TECH_BINAURA,
  SE_TECH_ESS_TECH,SE_TECH_HARMAN_VMAX,SE_TECH_NVIDEA,SE_TECH_PHILIPS_INCREDIBLE,SE_TECH_TEXAS_INST,SE_TECH_VLSI_TECH
} SE_TECHNIQUE;
...
typedef enum {
  KSPROPERTY_SYSAUDIO_NORMAL_DEFAULT = 0,KSPROPERTY_SYSAUDIO_PLAYBACK_DEFAULT,KSPROPERTY_SYSAUDIO_RECORD_DEFAULT,KSPROPERTY_SYSAUDIO_MIDI_DEFAULT,KSPROPERTY_SYSAUDIO_MIXER_DEFAULT
...
typedef enum {
  KSMETHOD_WAVETABLE_WAVE_ALLOC,KSMETHOD_WAVETABLE_WAVE_FREE,KSMETHOD_WAVETABLE_WAVE_FIND,KSMETHOD_WAVETABLE_WAVE_WRITE
} KSMETHOD_WAVETABLE;
...
typedef enum {
  KSPROPERTY_AEC_NOISE_FILL_ENABLE = 0,KSPROPERTY_AEC_STATUS,KSPROPERTY_AEC_MODE
} KSPROPERTY_AEC;
...
typedef enum {
  KSPROPERTY_WAVETABLE_LOAD_SAMPLE,KSPROPERTY_WAVETABLE_UNLOAD_SAMPLE,KSPROPERTY_WAVETABLE_MEMORY,KSPROPERTY_WAVETABLE_VERSION
...
typedef enum {
  KSPROPERTY_SYSAUDIO_DEVICE_COUNT = 1,KSPROPERTY_SYSAUDIO_DEVICE_FRIENDLY_NAME = 2,KSPROPERTY_SYSAUDIO_DEVICE_INSTANCE = 3,
  KSPROPERTY_SYSAUDIO_DEVICE_INTERFACE_NAME = 4,KSPROPERTY_SYSAUDIO_SELECT_GRAPH = 5,KSPROPERTY_SYSAUDIO_CREATE_VIRTUAL_SOURCE = 6,
  KSPROPERTY_SYSAUDIO_DEVICE_DEFAULT = 7,KSPROPERTY_SYSAUDIO_INSTANCE_INFO = 14,KSPROPERTY_SYSAUDIO_COMPONENT_ID = 16
} KSPROPERTY_SYSAUDIO;
...
typedef enum {
  KSPROPERTY_AUDIOGFX_RENDERTARGETDEVICEID,KSPROPERTY_AUDIOGFX_CAPTURETARGETDEVICEID
} KSPROPERTY_AUDIOGFX;
...
typedef enum {
  KSPROPERTY_AUDDECOUT_MODES,KSPROPERTY_AUDDECOUT_CUR_MODE
...
typedef enum {
  KSPROPERTY_DVDSUBPIC_PALETTE,KSPROPERTY_DVDSUBPIC_HLI,KSPROPERTY_DVDSUBPIC_COMPOSIT_ON
...
typedef enum {
  KS_DVDCOPYSTATE_INITIALIZE,KS_DVDCOPYSTATE_INITIALIZE_TITLE,KS_DVDCOPYSTATE_AUTHENTICATION_NOT_REQUIRED,
  KS_DVDCOPYSTATE_AUTHENTICATION_REQUIRED,KS_DVDCOPYSTATE_DONE
} KS_DVDCOPYSTATE;

typedef enum {
  KS_MACROVISION_DISABLED,KS_MACROVISION_LEVEL1,KS_MACROVISION_LEVEL2,KS_MACROVISION_LEVEL3
...
typedef enum {
  KS_MPEG2Level_Low,KS_MPEG2Level_Main,KS_MPEG2Level_High1440,KS_MPEG2Level_High
} KS_MPEG2Level;

typedef enum {
  KS_MPEG2Profile_Simple,KS_MPEG2Profile_Main,KS_MPEG2Profile_SNRScalable,KS_MPEG2Profile_SpatiallyScalable,KS_MPEG2Profile_High
} KS_MPEG2Profile;
...
typedef enum {
  KSPROPERTY_VBICODECFILTERING_SCANLINES_REQUESTED_BIT_ARRAY = 0x01,KSPROPERTY_VBICODECFILTERING_SCANLINES_DISCOVERED_BIT_ARRAY,
  KSPROPERTY_VBICODECFILTERING_SUBSTREAMS_REQUESTED_BIT_ARRAY,KSPROPERTY_VBICODECFILTERING_SUBSTREAMS_DISCOVERED_BIT_ARRAY,
...
typedef enum {
  KSPROPERTY_ALLOCATOR_CONTROL_HONOR_COUNT,KSPROPERTY_ALLOCATOR_CONTROL_SURFACE_SIZE,KSPROPERTY_ALLOCATOR_CONTROL_CAPTURE_CAPS,
...
typedef enum {
  ...
  KSPROPERTY_VIDEOPROCAMP_BACKLIGHT_COMPENSATION,KSPROPERTY_VIDEOPROCAMP_GAIN,KSPROPERTY_VIDEOPROCAMP_DIGITAL_MULTIPLIER,
  KSPROPERTY_VIDEOPROCAMP_DIGITAL_MULTIPLIER_LIMIT,KSPROPERTY_VIDEOPROCAMP_WHITEBALANCE_COMPONENT,KSPROPERTY_VIDEOPROCAMP_POWERLINE_FREQUENCY
...
typedef enum {
  KSPROPERTY_SELECTOR_SOURCE_NODE_ID,KSPROPERTY_SELECTOR_NUM_SOURCES
...
typedef enum {
  KSPROPERTY_TUNER_CAPS,KSPROPERTY_TUNER_MODE_CAPS,KSPROPERTY_TUNER_MODE,KSPROPERTY_TUNER_STANDARD,KSPROPERTY_TUNER_FREQUENCY,
  KSPROPERTY_TUNER_INPUT,KSPROPERTY_TUNER_STATUS,KSPROPERTY_TUNER_IF_MEDIUM
} KSPROPERTY_TUNER;

typedef enum {
  KSPROPERTY_TUNER_MODE_TV = 0X0001,KSPROPERTY_TUNER_MODE_FM_RADIO = 0X0002,KSPROPERTY_TUNER_MODE_AM_RADIO = 0X0004,
  KSPROPERTY_TUNER_MODE_DSS = 0X0008,KSPROPERTY_TUNER_MODE_ATSC = 0X0010
} KSPROPERTY_TUNER_MODES;

typedef enum {
  KS_TUNER_TUNING_EXACT = 1,KS_TUNER_TUNING_FINE,KS_TUNER_TUNING_COARSE
} KS_TUNER_TUNING_FLAGS;

typedef enum {
  KS_TUNER_STRATEGY_PLL = 0X01,KS_TUNER_STRATEGY_SIGNAL_STRENGTH = 0X02,KS_TUNER_STRATEGY_DRIVER_TUNES = 0X04
} KS_TUNER_STRATEGY;
...
typedef enum {
  KSPROPERTY_VIDEOENCODER_CAPS,KSPROPERTY_VIDEOENCODER_STANDARD,KSPROPERTY_VIDEOENCODER_COPYPROTECTION,KSPROPERTY_VIDEOENCODER_CC_ENABLE
...
typedef enum {
  KS_VIDEODECODER_FLAGS_CAN_DISABLE_OUTPUT = 0X0001,KS_VIDEODECODER_FLAGS_CAN_USE_VCR_LOCKING = 0X0002,
...
typedef enum {
  ...
  KSPROPERTY_CAMERACONTROL_ROLL_RELATIVE,KSPROPERTY_CAMERACONTROL_ZOOM_RELATIVE,KSPROPERTY_CAMERACONTROL_EXPOSURE_RELATIVE,
  KSPROPERTY_CAMERACONTROL_IRIS_RELATIVE,KSPROPERTY_CAMERACONTROL_FOCUS_RELATIVE,KSPROPERTY_CAMERACONTROL_PANTILT_RELATIVE,
...
typedef enum {
  KSPROPERTY_EXTDEVICE_ID,KSPROPERTY_EXTDEVICE_VERSION,KSPROPERTY_EXTDEVICE_POWER_STATE,KSPROPERTY_EXTDEVICE_PORT,KSPROPERTY_EXTDEVICE_CAPABILITIES
...
typedef enum {
  KSPROPERTY_EXTXPORT_CAPABILITIES,KSPROPERTY_EXTXPORT_INPUT_SIGNAL_MODE,KSPROPERTY_EXTXPORT_OUTPUT_SIGNAL_MODE,
  KSPROPERTY_EXTXPORT_LOAD_MEDIUM,KSPROPERTY_EXTXPORT_MEDIUM_INFO,KSPROPERTY_EXTXPORT_STATE,KSPROPERTY_EXTXPORT_STATE_NOTIFY,
  KSPROPERTY_EXTXPORT_TIMECODE_SEARCH,KSPROPERTY_EXTXPORT_ATN_SEARCH,KSPROPERTY_EXTXPORT_RTC_SEARCH,KSPROPERTY_RAW_AVC_CMD
} KSPROPERTY_EXTXPORT;
...
typedef enum {
  KSPROPERTY_TIMECODE_READER,KSPROPERTY_ATN_READER,KSPROPERTY_RTC_READER
} KSPROPERTY_TIMECODE;
...
typedef enum {
  KSEVENT_EXTDEV_COMMAND_NOTIFY_INTERIM_READY,KSEVENT_EXTDEV_COMMAND_CONTROL_INTERIM_READY,KSEVENT_EXTDEV_COMMAND_BUSRESET,
...
typedef enum {
  KSPROPERTY_CROSSBAR_CAPS,KSPROPERTY_CROSSBAR_PININFO,KSPROPERTY_CROSSBAR_CAN_ROUTE,KSPROPERTY_CROSSBAR_ROUTE
...
typedef enum {
  KS_PhysConn_Video_Tuner = 1,KS_PhysConn_Video_Composite,KS_PhysConn_Video_SVideo,KS_PhysConn_Video_RGB,KS_PhysConn_Video_YRYBY,
  KS_PhysConn_Video_SerialDigital,KS_PhysConn_Video_ParallelDigital,KS_PhysConn_Video_SCSI,KS_PhysConn_Video_AUX,KS_PhysConn_Video_1394,
  KS_PhysConn_Video_USB,KS_PhysConn_Video_VideoDecoder,KS_PhysConn_Video_VideoEncoder,KS_PhysConn_Video_SCART,KS_PhysConn_Audio_Tuner = 4096,
  KS_PhysConn_Audio_Line,KS_PhysConn_Audio_Mic,KS_PhysConn_Audio_AESDigital,KS_PhysConn_Audio_SPDIFDigital,KS_PhysConn_Audio_SCSI,
...
typedef enum {
  KSPROPERTY_TVAUDIO_CAPS,KSPROPERTY_TVAUDIO_MODE,KSPROPERTY_TVAUDIO_CURRENTLY_AVAILABLE_MODES
...
typedef enum {
  KSPROPERTY_VIDEOCOMPRESSION_GETINFO,KSPROPERTY_VIDEOCOMPRESSION_KEYFRAME_RATE,KSPROPERTY_VIDEOCOMPRESSION_PFRAMES_PER_KEYFRAME,
  KSPROPERTY_VIDEOCOMPRESSION_QUALITY,KSPROPERTY_VIDEOCOMPRESSION_OVERRIDE_KEYFRAME,KSPROPERTY_VIDEOCOMPRESSION_OVERRIDE_FRAME_SIZE,
...
typedef enum {
  KS_StreamingHint_FrameInterval = 0x0100,KS_StreamingHint_KeyFrameRate = 0x0200,KS_StreamingHint_PFrameRate = 0x0400,
  KS_StreamingHint_CompQuality = 0x0800,KS_StreamingHint_CompWindowSize = 0x1000
...
typedef enum {
  KSPROPERTY_OVERLAYUPDATE_INTERESTS,KSPROPERTY_OVERLAYUPDATE_CLIPLIST = 0x1,KSPROPERTY_OVERLAYUPDATE_PALETTE = 0x2,
  KSPROPERTY_OVERLAYUPDATE_COLORKEY = 0x4,KSPROPERTY_OVERLAYUPDATE_VIDEOPOSITION = 0x8,KSPROPERTY_OVERLAYUPDATE_DISPLAYCHANGE = 0x10,
...
#define DEFINE_KSPROPERTY_ITEM_OVERLAYUPDATE_INTERESTS(Handler) DEFINE_KSPROPERTY_ITEM(KSPROPERTY_OVERLAYUPDATE_INTERESTS,(Handler),sizeof(KSPROPERTY),sizeof(ULONG),NULL,NULL,0,NULL,NULL,0)
#define DEFINE_KSPROPERTY_ITEM_OVERLAYUPDATE_PALETTE(Handler) DEFINE_KSPROPERTY_ITEM(KSPROPERTY_OVERLAYUPDATE_PALETTE,NULL,sizeof(KSPROPERTY),0,(Handler),NULL,0,NULL,NULL,0)
#define DEFINE_KSPROPERTY_ITEM_OVERLAYUPDATE_COLORKEY(Handler) DEFINE_KSPROPERTY_ITEM(KSPROPERTY_OVERLAYUPDATE_COLORKEY,NULL,sizeof(KSPROPERTY),sizeof(COLORKEY),(Handler),NULL,0,NULL,NULL,0)
#define DEFINE_KSPROPERTY_ITEM_OVERLAYUPDATE_CLIPLIST(Handler) DEFINE_KSPROPERTY_ITEM(KSPROPERTY_OVERLAYUPDATE_CLIPLIST,NULL,sizeof(KSPROPERTY),2 *sizeof(RECT) + sizeof(RGNDATAHEADER),(Handler),NULL,0,NULL,NULL,0)
#define DEFINE_KSPROPERTY_ITEM_OVERLAYUPDATE_VIDEOPOSITION(Handler) DEFINE_KSPROPERTY_ITEM(KSPROPERTY_OVERLAYUPDATE_VIDEOPOSITION,NULL,sizeof(KSPROPERTY),2 *sizeof(RECT),(Handler),NULL,0,NULL,NULL,0)
#define DEFINE_KSPROPERTY_ITEM_OVERLAYUPDATE_DISPLAYCHANGE(Handler) DEFINE_KSPROPERTY_ITEM(KSPROPERTY_OVERLAYUPDATE_DISPLAYCHANGE,NULL,sizeof(KSPROPERTY),sizeof(KSDISPLAYCHANGE),(Handler),NULL,0,NULL,NULL,0)
#define DEFINE_KSPROPERTY_ITEM_OVERLAYUPDATE_COLORREF(Handler) DEFINE_KSPROPERTY_ITEM(KSPROPERTY_OVERLAYUPDATE_COLORREF,(Handler),sizeof(KSPROPERTY),sizeof(COLORREF),NULL,NULL,0,NULL,NULL,0)
...
typedef enum {
  KSPROPERTY_VIDEOCONTROL_CAPS,KSPROPERTY_VIDEOCONTROL_ACTUAL_FRAME_RATE,KSPROPERTY_VIDEOCONTROL_FRAME_RATES,KSPROPERTY_VIDEOCONTROL_MODE
} KSPROPERTY_VIDCAP_VIDEOCONTROL;

typedef enum {
  KS_VideoControlFlag_FlipHorizontal = 0x0001,KS_VideoControlFlag_FlipVertical = 0x0002,KS_Obsolete_VideoControlFlag_ExternalTriggerEnable = 0x0010,
  KS_Obsolete_VideoControlFlag_Trigger = 0x0020,KS_VideoControlFlag_ExternalTriggerEnable = 0x0004,KS_VideoControlFlag_Trigger = 0x0008
...
typedef enum {
  KS_AMVP_MODE_WEAVE,KS_AMVP_MODE_BOBINTERLEAVED,KS_AMVP_MODE_BOBNONINTERLEAVED,KS_AMVP_MODE_SKIPEVEN,KS_AMVP_MODE_SKIPODD
} KS_AMVP_MODE;
...
typedef enum {
  KSEVENT_VIDCAPTOSTI_EXT_TRIGGER,KSEVENT_VIDCAP_AUTO_UPDATE,KSEVENT_VIDCAP_SEARCH
} KSEVENT_VIDCAPTOSTI;

typedef enum {
  KSPROPERTY_EXTENSION_UNIT_INFO,KSPROPERTY_EXTENSION_UNIT_CONTROL,KSPROPERTY_EXTENSION_UNIT_PASS_THROUGH = 0xffff
...
typedef enum {
  KS_AM_RATE_SimpleRateChange=1,KS_AM_RATE_ExactRateChange=2,KS_AM_RATE_MaxFullDataRate=3,KS_AM_RATE_Step=4
