...
#define SERVICE_NT_CCP_CODE(tt,nn) (((long)SERVICE_CCP_QUERY_HINT) | ((long)(nn)) | (((tt)&LOWER_HINT_MASK) << SERVICE_IP_WAITTIME_SHIFT) | (((tt)&UPPER_HINT_MASK) << SERVICE_NTIP_WAITTIME_SHIFT))
