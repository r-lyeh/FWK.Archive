...
#define __INewMail_INTERFACE_DEFINED__
  ...
  public:
    ...
    virtual HRESULT WINAPI put_Importance(long newVal) = 0;
    virtual HRESULT WINAPI put_BodyFormat(long newVal) = 0;
    virtual HRESULT WINAPI put_MailFormat(long newVal) = 0;
    ...
    virtual HRESULT WINAPI SetLocaleIDs(long CodePageID) = 0;
  ...
  typedef struct INewMailVtbl {
    BEGIN_INTERFACE
      ...
      HRESULT (WINAPI *put_Importance)(INewMail *This,long newVal);
      HRESULT (WINAPI *put_BodyFormat)(INewMail *This,long newVal);
      HRESULT (WINAPI *put_MailFormat)(INewMail *This,long newVal);
      ...
      HRESULT (WINAPI *SetLocaleIDs)(INewMail *This,long CodePageID);
...
#define INewMail_get_Version(This,Version) (This)->lpVtbl->get_Version(This,Version)
  ...
  HRESULT WINAPI INewMail_put_Importance_Proxy(INewMail *This,long newVal);
  ...
  HRESULT WINAPI INewMail_put_BodyFormat_Proxy(INewMail *This,long newVal);
  ...
  HRESULT WINAPI INewMail_put_MailFormat_Proxy(INewMail *This,long newVal);
  ...
  HRESULT WINAPI INewMail_SetLocaleIDs_Proxy(INewMail *This,long CodePageID);
...
#define __ISession_INTERFACE_DEFINED__
  ...
  public:
    ...
    virtual HRESULT WINAPI get_Class(long *varClass) = 0;
    ...
    virtual HRESULT WINAPI get_MessageFormat(long *pMessageFormat) = 0;
    virtual HRESULT WINAPI put_MessageFormat(long varMessageFormat) = 0;
  ...
  typedef struct ISessionVtbl {
    BEGIN_INTERFACE
      ...
      HRESULT (WINAPI *get_Class)(ISession *This,long *varClass);
      ...
      HRESULT (WINAPI *get_MessageFormat)(ISession *This,long *pMessageFormat);
      HRESULT (WINAPI *put_MessageFormat)(ISession *This,long varMessageFormat);
      ...
      HRESULT (WINAPI *SetLocaleIDs)(ISession *This,long CodePageID);
...
#define ISession_SetReserved(This,var1,var2) (This)->lpVtbl->SetReserved(This,var1,var2)
  ...
  HRESULT WINAPI ISession_get_Class_Proxy(ISession *This,long *varClass);
  ...
  HRESULT WINAPI ISession_get_MessageFormat_Proxy(ISession *This,long *pMessageFormat);
  ...
  HRESULT WINAPI ISession_put_MessageFormat_Proxy(ISession *This,long varMessageFormat);
  ...
  HRESULT WINAPI ISession_SetLocaleIDs_Proxy(ISession *This,long CodePageID);
...
#define __Folder_INTERFACE_DEFINED__
  ...
  typedef struct FolderVtbl {
    BEGIN_INTERFACE
      ...
      HRESULT (WINAPI *get_Class)(Folder *This,long *varClass);
...
#define Folder_get_Messages(This,varMessages) (This)->lpVtbl->get_Messages(This,varMessages)
  ...
  HRESULT WINAPI Folder_get_Class_Proxy(Folder *This,long *varClass);
...
#define __Messages_INTERFACE_DEFINED__
  ...
  typedef struct MessagesVtbl {
    BEGIN_INTERFACE
      ...
      HRESULT (WINAPI *get_Class)(Messages *This,long *varClass);
      HRESULT (WINAPI *get_Count)(Messages *This,long *varCount);
...
#define Messages_GetPrevious(This,pvarResult) (This)->lpVtbl->GetPrevious(This,pvarResult)
  ...
  HRESULT WINAPI Messages_get_Class_Proxy(Messages *This,long *varClass);
  ...
  HRESULT WINAPI Messages_get_Count_Proxy(Messages *This,long *varCount);
...
#define __Message_INTERFACE_DEFINED__
  ...
  public:
    ...
    virtual HRESULT WINAPI get_Session(VARIANT *varSession) = 0;
    virtual HRESULT WINAPI get_Class(long *varClass) = 0;
    virtual HRESULT WINAPI get_Size(long *varSize) = 0;
    virtual HRESULT WINAPI get_Importance(long *pImportance) = 0;
    virtual HRESULT WINAPI put_Importance(long varImportance) = 0;
    ...
    virtual HRESULT WINAPI put_MessageFormat(long __MIDL_0011) = 0;
  ...
  typedef struct MessageVtbl {
    BEGIN_INTERFACE
      ...
      HRESULT (WINAPI *get_Class)(Message *This,long *varClass);
      HRESULT (WINAPI *get_Size)(Message *This,long *varSize);
      HRESULT (WINAPI *get_Importance)(Message *This,long *pImportance);
      HRESULT (WINAPI *put_Importance)(Message *This,long varImportance);
      ...
      HRESULT (WINAPI *put_MessageFormat)(Message *This,long __MIDL_0011);
...
#define Message_Send(This) (This)->lpVtbl->Send(This)
  ...
  HRESULT WINAPI Message_get_Class_Proxy(Message *This,long *varClass);
  ...
  HRESULT WINAPI Message_get_Size_Proxy(Message *This,long *varSize);
  ...
  HRESULT WINAPI Message_get_Importance_Proxy(Message *This,long *pImportance);
  ...
  HRESULT WINAPI Message_put_Importance_Proxy(Message *This,long varImportance);
  ...
  HRESULT WINAPI Message_put_MessageFormat_Proxy(Message *This,long __MIDL_0011);
...
#define __Recipients_INTERFACE_DEFINED__
  ...
  typedef struct RecipientsVtbl {
    BEGIN_INTERFACE
      ...
      HRESULT (WINAPI *get_Class)(Recipients *This,long *varClass);
      HRESULT (WINAPI *get_Item)(Recipients *This,VARIANT *var,VARIANT *pvarResult);
      HRESULT (WINAPI *get_Count)(Recipients *This,long *varCount);
...
#define Recipients_Delete(This) (This)->lpVtbl->Delete(This)
  ...
  HRESULT WINAPI Recipients_get_Class_Proxy(Recipients *This,long *varClass);
  ...
  HRESULT WINAPI Recipients_get_Count_Proxy(Recipients *This,long *varCount);
...
#define __Recipient_INTERFACE_DEFINED__
  ...
  public:
    ...
    virtual HRESULT WINAPI get_Type(long *pType) = 0;
    virtual HRESULT WINAPI put_Type(long varType) = 0;
  ...
  typedef struct RecipientVtbl {
    BEGIN_INTERFACE
      ...
      HRESULT (WINAPI *get_Class)(Recipient *This,long *varClass);
      HRESULT (WINAPI *get_Name)(Recipient *This,BSTR *pbstrName);
      HRESULT (WINAPI *put_Name)(Recipient *This,BSTR bstrName);
      HRESULT (WINAPI *get_Type)(Recipient *This,long *pType);
      HRESULT (WINAPI *put_Type)(Recipient *This,long varType);
...
#define Recipient_Delete(This) (This)->lpVtbl->Delete(This)
  ...
  HRESULT WINAPI Recipient_get_Class_Proxy(Recipient *This,long *varClass);
  ...
  HRESULT WINAPI Recipient_get_Type_Proxy(Recipient *This,long *pType);
  ...
  HRESULT WINAPI Recipient_put_Type_Proxy(Recipient *This,long varType);
...
#define __Attachments_INTERFACE_DEFINED__
  ...
  typedef struct AttachmentsVtbl {
    BEGIN_INTERFACE
      ...
      HRESULT (WINAPI *get_Class)(Attachments *This,long *varClass);
      HRESULT (WINAPI *get_Item)(Attachments *This,VARIANT *var,VARIANT *pvarResult);
      HRESULT (WINAPI *get_Count)(Attachments *This,long *varCount);
...
#define Attachments_Delete(This) (This)->lpVtbl->Delete(This)
  ...
  HRESULT WINAPI Attachments_get_Class_Proxy(Attachments *This,long *varClass);
  ...
  HRESULT WINAPI Attachments_get_Count_Proxy(Attachments *This,long *varCount);
...
#define __Attachment_INTERFACE_DEFINED__
  ...
  typedef struct AttachmentVtbl {
    BEGIN_INTERFACE
      ...
      HRESULT (WINAPI *get_Class)(Attachment *This,long *varClass);
      HRESULT (WINAPI *get_Name)(Attachment *This,BSTR *pbstrName);
      HRESULT (WINAPI *put_Name)(Attachment *This,BSTR bstrName);
      HRESULT (WINAPI *get_Type)(Attachment *This,long *pType);
      HRESULT (WINAPI *put_Type)(Attachment *This,long varType);
...
#define Attachment_WriteToFile(This,FileName) (This)->lpVtbl->WriteToFile(This,FileName)
  ...
  HRESULT WINAPI Attachment_get_Class_Proxy(Attachment *This,long *varClass);
  ...
  HRESULT WINAPI Attachment_get_Type_Proxy(Attachment *This,long *pType);
  ...
  HRESULT WINAPI Attachment_put_Type_Proxy(Attachment *This,long varType);
...
#define __AddressEntry_INTERFACE_DEFINED__
  ...
  typedef struct AddressEntryVtbl {
    BEGIN_INTERFACE
      ...
      HRESULT (WINAPI *get_Class)(AddressEntry *This,long *varClass);
...
#define AddressEntry_get_Type(This,varType) (This)->lpVtbl->get_Type(This,varType)
  ...
  HRESULT WINAPI AddressEntry_get_Class_Proxy(AddressEntry *This,long *varClass);
