...
void test_obj_ecs() {
    ...
    for( int i = 0; i < 32; ++i) test(0 == entity_hascomponent(e, i));
    for( int i = 0; i < 32; ++i) test(1 == entity_addcomponent(e, i, NULL));
    for( int i = 0; i < 32; ++i) test(1 == entity_hascomponent(e, i));
    for( int i = 0; i < 32; ++i) test(1 == entity_delcomponent(e, i));
    for( int i = 0; i < 32; ++i) test(0 == entity_hascomponent(e, i));
}
