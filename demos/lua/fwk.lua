--autogenerated luajit bindings. do not edit. 2022/04/10
local ffi = require("ffi")
ffi.cdef([[
//lcpp INF [0000] vec2: macro name but used as C declaration in:typedef union vec2 { struct { float X,Y; };     struct { float x,y; }; struct { float r,g; }; struct { float w,h; }; struct { float min,max; }; float v2[2]; float array[1]; } vec2;
//lcpp INF [0000] array: macro name but used as C declaration in:typedef union vec2 { struct { float X,Y; };     struct { float x,y; }; struct { float r,g; }; struct { float w,h; }; struct { float min,max; }; float v2[2]; float array[1]; } vec2;
//lcpp INF [0000] vec2: macro name but used as C declaration in:typedef union vec2 { struct { float X,Y; };     struct { float x,y; }; struct { float r,g; }; struct { float w,h; }; struct { float min,max; }; float v2[2]; float array[1]; } vec2;
...
pair** sorted;
 ...
 FILE*        file_temp();
 char*        file_tempname();
 char** zipfile_list(const char *zipname);
 char*  zipfile_extract(const char *zipname, const char *filename);
...
int flags;
 ...
 void*    screenshot_async(unsigned components);
