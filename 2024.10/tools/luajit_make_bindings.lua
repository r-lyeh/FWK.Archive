...
io.input("./engine/engine.h")
local engine_h = io.read("*all")
engine_h = engine_h:gsub("#line", "//#line")
engine_h = engine_h:gsub("#include", "//#include")

print('--autogenerated luajit bindings. do not edit.') -- .. os.date("%Y/%m/%d"))
print('local ffi = require("ffi")')
print('ffi.cdef([[')

local result = lcpp.cppString(glue .. engine_h, '-', {"-Znopass"}, 'engine')
